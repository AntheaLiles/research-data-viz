...
#+name: fig:Palette d'accentuation
[[./img/palette-evidence.pdf]]

Lors de l'emploi de la palette d'accentuation il est important que la couleur de base n'attire pas l'attention. Le focus de l'utilisateur doit rester sur l'élément accentué. [cite:@Wilke2019p34]
Le plus efficace est de tracer tous les éléments dans un gris homogène et léger et n'afficher que les valeurs accentuées avec la couleur retenue. [cite:@Wilke2019p34]

#+name: fig:Palette binaire
[[./img/palette-binaire.pdf]]


#+name: fig:Palette divergente
[[./img/palette-divergente.pdf]]

Cette palette est utilisée pour accompagner la visualisation de la déviation de données dans deux directions opposées à un point central. [cite:@Wilke2019p30]

Il convient que les écarts de contraste des deux extrémitées avec le point central soit égal. Il convient également qu'il y ai le même nombre d'échelons colorés de part et d'autre du point central. [cite:@Wilke2019p30]

Il convient de ne pas utiliser le rouge et le vert conjointement comme teintes d'extrémités car environ 4% de la population ne peut pas discriminer ces couleurs. [cite:@CenteringAccessibilityInDataviz p4]

#+name: fig:Palette monochrome
[[./img/palette-monochrome.pdf]]

Aussi appelée "séquentielle", cette palette de couleur est utilisée pour représenter la nature quantitative d'une donnée. [cite:@Wilke2019p29]
...
Il convient d'employer une graduation présente dans l'environnement natuel, partant par exemple d'un bleu foncé et évoluent vers un jaune clair. [cite:@Wilke2019p30]

#+name: fig:Palette thermique
...
#+name: fig:Palette catégorique
[[./img/palette-categorique.pdf]]

N'employez cette palette de couleur que lorsque les données affichées n'ont aucun lien intrinsèque. [cite:@Wilke2019p27]
...
:data-type-y:
:END:
#+name: fig:Icone de nuage de point
#+attr_latex: :center nil :width 1.2cm :float warp :placement {l}{0\textwidth}
...
La valeur actuelle mesurée ou calculée est observée au moyen d'une barre horizontale constrastant avec l'arrière plan. [cite:@Schwabis2021p120]
La valeur cible est représenté par une ligne verticale. [cite:@alansmithLexiqueVisuel]
L'arrière plan expose 3 zones dites qualitative et associées à des notions de performance (eg. inférieur, moyen, bon). [cite:@Sosulski2019p47]

Editer une série de tirets permet d'exposer au lecteur diverses comparaisons tout en restant compacte. [cite:@Schwabish2021p120]
