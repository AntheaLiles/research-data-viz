...
En premier lieu, il convient de vérifier l'abscence de "distortion" des données affichées pour limiter les biais inhérents.[cite:@Few2012p192]
...
Il existe 4 types de diagrammes de réseaux : [cite:@Schwabish2021p278]
...
Bien que répendu dans les analyses marketing (suivi des processus de vente), ce graphique n'est pas réellement pertinent. Sa composition ne représente pas correcement les données et il n'est pas évident de comprendre les différences entre chaque segments.[cite:@Few2012p283]
