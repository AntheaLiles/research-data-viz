...
\section*{Sémantique}
\label{sec:orgf02e2c5}
\section*{Polices}
\label{sec:orge467e9e}
...
\section*{Couleurs}
\label{sec:org3a4fcac}
L'utilisation de la couleur n'est pas nécessaire pour éditer un graphique efficace. Il s'agit par exemple de la manière la moins efficace pour représenter des différences entre des variables. \autocite{Beecham2021}
...
\caption{\label{fig:orgd578012}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:orgfdaea4f}Palette binaire}
\end{figure}
...
\caption{\label{fig:org362a121}Palette divergente}
\end{figure}
...
\caption{\label{fig:orgab6761c}Palette monochrome}
\end{figure}
...
\caption{\label{fig:orgf59e290}Palette thermique}
\end{figure}
...
\caption{\label{fig:org4e9860e}Palette catégorique}
\end{center}
...
\caption{\label{fig:orge89679a}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\section*{Tables}
\label{sec:org6345664}
...
\label{sec:orgc636380}

\section*{Graphiques}
\label{sec:org03d287b}
\subsection*{Arbre de mot}
\label{sec:orgac80aae}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org33cf0f7]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
Il est, autrement, en tout point similaire aux \hyperref[sec:org2f30936]{Camembert}
\subsection*{Etats parallèles}
\label{sec:org99a7f13}
...
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:orgc38788a]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:orgdbcfb84]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:org52d3524]{Matrice de graphique}.
\end{itemize}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:orgaf8e26d]{Tiret}.
\subsection*{Ligne}
\label{sec:org3b997d4}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:org52d3524]{Matrice de graphique}.
\end{itemize}
...
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:org4e9860e})

Dans un maximum de 4 catégories de données, il est possible d'utiliser un double encodage combinant une forme et une couleur.\autocite{andreaskrauseBestPracticesData2024}
...
\caption{\label{fig:org28177c2}Formes des points de données}
\end{figure}
...
\end{center}
\section*{Glossaire}
\label{sec:org5fda4c0}
\subsection*{Vocabulaire technique}
\label{sec:org25b3dbb}
\begin{description}
