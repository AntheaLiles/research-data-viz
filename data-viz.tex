...
\section*{Composants}
\label{sec:org74d6470}
\subsection*{Polices}
\label{sec:orgc27afb9}
...
\caption{\label{fig:orga671618}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:org768d543}Palette binaire}
\end{figure}
...
\caption{\label{fig:orgb4e2926}Palette divergente}
\end{figure}
...
\caption{\label{fig:org64bb3c9}Palette monochrome}
\end{figure}
...
\caption{\label{fig:org914a07b}Palette thermique}
\end{figure}
...
\caption{\label{fig:org43dece3}Palette catégorique}
\end{figure}
...
\caption{\label{fig:org0c5eec7}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:org5ce6ce1}
\subsubsection*{Titre}
\label{sec:org2864fb0}
\subsubsection*{Cadre}
\label{sec:org3834321}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:org5a4be08}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:org9846a31]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
\caption{\label{fig:org098e9a0}Contenu type d'un texte alternatif selon le médium concerné}
\end{figure}
...
\label{sec:org52d03c3}
\section*{Méthode de validation}
\label{sec:org5a02030}
...
\section*{Graphiques}
\label{sec:org42967a1}
\subsection*{Arbre de mot}
\label{sec:org52c845a}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org34f2ccf]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
\label{sec:orgffce851}

Heatmap
\subsection*{Cascade}
\label{sec:org6f12cba}
...
Il est, autrement, en tout point similaire aux \hyperref[sec:org5e34da5]{Camembert}
\subsection*{Etats parallèles}
\label{sec:org1a9dec1}
...
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:orgeaf6042]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:org23a5d95]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:orga4ae8ea]{Matrice de graphique}.
\end{itemize}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:org31fc550]{Tiret}.
\subsection*{Ligne}
\label{sec:org9d40949}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:orga4ae8ea]{Matrice de graphique}.
\end{itemize}
...
\caption{\label{fig:org10e1eda}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Matrice de température}
\label{sec:org34b5322}
...
\label{sec:org8fa4d36}
Représente la relation entres deux variables continues. \autocite{alansmithLexiqueVisuel}
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:org43dece3})
...
\caption{\label{fig:orgc272214}Formes des points de données}
\end{figure}
...
Si la quantité de chaque étape d'un processus est l'information la plus importante, il est préférable d'avoir recours à un diagramme en \hyperref[sec:org3af4803]{Barre ordonnée}.

S'il est  souhaité de visualiser les pertes quantitatives au fil d'un processus, il sera préférable d'employer un diagramme de \hyperref[sec:org6a4b546]{Sankey}.
\subsection*{Treemap}
\label{sec:orga2c3a79}
...
\end{center}
\section*{Glossaire}
\label{sec:org82c23df}
\subsection*{Vocabulaire technique}
\label{sec:org7bcc9e3}
\begin{description}
