...
\section*{Composants}
\label{sec:org155956c}
\subsection*{Polices}
\label{sec:org58ec1b0}
...
\caption{\label{fig:orgb58e4ae}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:org02301fc}Palette binaire}
\end{figure}
...
\caption{\label{fig:org135cfa8}Palette divergente}
\end{figure}
...
\caption{\label{fig:org73ced1c}Palette Séquencielle}
\end{figure}
...
\caption{\label{fig:orga2f620e}Palette thermique}
\end{figure}
...
\caption{\label{fig:org02befec}Palette catégorique}
\end{figure}
...
\caption{\label{fig:org78e6dc6}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:orgddf4714}
\subsubsection*{Titre}
\label{sec:org03adee0}
\subsubsection*{Cadre}
\label{sec:org46313fd}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:orgec15932}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:org910696e]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
\caption{\label{fig:orgfca3505}Contenu type d'un texte alternatif selon l'usage concerné}
\end{figure}
...
\label{sec:orge61e7f0}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/methode-de-selection.pdf}
\caption{\label{fig:org3b9e019}Matrice de sélection}
\end{figure*}
\section*{Méthode de validation}
\label{sec:org2034cea}
...
\section*{Graphiques}
\label{sec:org1d77aff}
\subsection*{Arbre de mot}
\label{sec:orge1a4e04}
...
\subsection*{Barre divergente empilée}
\label{sec:org2351ad7}
...
\subsection*{Barre empilée}
\label{sec:orgc5fa74c}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org1b7d901]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
Ce graphique utilise les couleurs de la palette thermique \ref{fig:orga2f620e}.
...
Il est, autrement, en tout point similaire aux \hyperref[sec:org98909e2]{Camembert}
\subsection*{Eventail}
\label{sec:org53da8f1}
Utilisé pour montrer l'incertitude des projections futures. \autocite{alansmithLexiqueVisuel}
\subsection*{Haltères}
\label{sec:org44291db}
...
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:org8aec8c4]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:orgf09a52e]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:org855a817]{Matrice de graphique}.
\end{itemize}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:org10010af]{Tiret}.
\subsection*{Ligne}
\label{sec:org264a4e0}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:org855a817]{Matrice de graphique}.
\end{itemize}
...
\caption{\label{fig:org0e1e187}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Minigraphe}
\label{sec:org6ab6db9}
...
\label{sec:org2797eb0}
Représente la relation entres deux variables continues. \autocite{alansmithLexiqueVisuel}
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:org02befec})
...
\caption{\label{fig:org2f92ddf}Formes des points de données}
\end{figure}
...
\end{center}
\section*{Glossaire}
\label{sec:org523a7c0}
\subsection*{Vocabulaire technique}
\label{sec:orgb4224dd}
\begin{description}
