...
\section*{Composants}
\label{sec:org5689c6c}
\subsection*{Polices}
\label{sec:orgfeaf5ea}
...
\caption{\label{fig:org8602e17}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:orge4a0925}Palette binaire}
\end{figure}
...
\caption{\label{fig:org5f482d9}Palette divergente}
\end{figure}
...
\caption{\label{fig:org75c0c4e}Palette monochrome}
\end{figure}
...
\caption{\label{fig:orgb57a459}Palette thermique}
\end{figure}
...
\caption{\label{fig:orgb9728a6}Palette catégorique}
\end{figure}
...
\caption{\label{fig:org0a8eee5}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:org96ef0ea}
\subsubsection*{Titre}
\label{sec:orgb749232}
\subsubsection*{Cadre}
\label{sec:org28343d1}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:orgbf136c8}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:org5367ef7]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
\caption{\label{fig:org4e9c8a5}Contenu type d'un texte alternatif selon le médium concerné}
\end{figure}
...
\label{sec:org93f3670}
\section*{Méthode de validation}
\label{sec:orgd73abbc}
...
\section*{Graphiques}
\label{sec:org3c3dd22}
\subsection*{Arbre de mot}
\label{sec:org8b789d9}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org2c1abf6]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
\label{sec:org3b8adc2}

Heatmap
\subsection*{Cascade}
\label{sec:org0642e3c}
...
Il est, autrement, en tout point similaire aux \hyperref[sec:org43ebc58]{Camembert}
\subsection*{Etats parallèles}
\label{sec:org70f453c}
...
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:orga250728]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:org9593ced]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:org22fe18a]{Matrice de graphique}.
\end{itemize}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:org9f19769]{Tiret}.
\subsection*{Ligne}
\label{sec:org536e588}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:org22fe18a]{Matrice de graphique}.
\end{itemize}
...
\caption{\label{fig:org7f34237}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Matrice de température}
\label{sec:org4f00def}
...
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:orgb9728a6})
...
\caption{\label{fig:org7be7996}Formes des points de données}
\end{figure}
...
Si la quantité de chaque étape d'un processus est l'information la plus importante, il est préférable d'avoir recours à un diagramme en \hyperref[sec:orgbbd4c65]{Barre ordonnée}.

S'il est  souhaité de visualiser les pertes quantitatives au fil d'un processus, il sera préférable d'employer un diagramme de \hyperref[sec:org8bcb238]{Sankey}.
\subsection*{Treemap}
\label{sec:orgbc36eb8}
...
\end{center}
\section*{Glossaire}
\label{sec:orga497ca1}
\subsection*{Vocabulaire technique}
\label{sec:org41919ec}
\begin{description}
