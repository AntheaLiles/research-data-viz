...
\section*{Composants}
\label{sec:org7a9d4d9}
\subsection*{Polices}
\label{sec:org8c05678}
...
\caption{\label{fig:org90df91d}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:org2367c03}Palette binaire}
\end{figure}
...
\caption{\label{fig:org5e24de5}Palette divergente}
\end{figure}
...
\caption{\label{fig:orga973df7}Palette Séquencielle}
\end{figure}
...
\caption{\label{fig:org93f06df}Palette thermique}
\end{figure}
...
\caption{\label{fig:orgbe4d69c}Palette catégorique}
\end{figure}
...
\caption{\label{fig:org6f2c257}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:orge5ab0e7}
Pour qu'un graphique s'intègre correctement dans un document, il convient de prévoir une zone de protection. Dans la figure \ref{fig:orgf894533} nous proposons un exemple de protection relative aux largeurs des marges latérales.

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{./img/general-graphics-rules.pdf}
\caption{\label{fig:orgf894533}Zones de protection d'un graphique}
\end{figure}
\subsubsection*{Cadre}
\label{sec:orgf30670a}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:orge61de0c}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:orge755f4f]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
Les recommendations de cette sections proviennent de l'ouvrage "Centering Accessibility in Data Visualization" \autocite{schwabishCenteringAccessibilityData2022}
...
\caption{\label{fig:org5eb3e69}Contenu type d'un texte alternatif selon l'usage concerné}
\end{figure}
...
La seconde direction est de filtrer les types de graphiques en fonction de l'objectif de l'utilisateur. Nous avons poursuivi notre étude dans ce sens. La figure \ref{fig:org9faf701} propose un premier niveau de discrimination des types de représentations en identifiant en premier lieu si le graphique doit s'actualiser en temps réel puis en orientant vers des catégories de graphiques au regards de l'objectif recherché.

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-filter.pdf}
\caption{\label{fig:org9faf701}Parcours de sélection initial}
\end{figure*}
...
\label{sec:orgd46d7e9}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-indicateur.pdf}
\caption{\label{fig:org8bae3e3}Séléction d'un graphique d'indicateur}
\end{figure*}
\subsubsection*{Marqueur}
\label{sec:org7c9a943}
...
\label{sec:org735e2c1}

\subsubsection*{Camembert}
\label{sec:org5455e10}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org7c9a943]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
Il est, autrement, en tout point similaire aux \hyperref[sec:org5455e10]{Camembert}
\subsubsection*{Quadrillage}
\label{sec:org6325def}
...
\label{sec:org349cfb2}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-classement.pdf}
\caption{\label{fig:org3d61152}Séléction d'un graphique de classement}
\end{figure*}
\subsubsection*{Barre ordonnée}
\label{sec:org0fdcbab}
...
\caption{\label{fig:orgac021da}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Distribution}
\label{sec:org5e4f7ba}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-distribution.pdf}
\caption{\label{fig:org1c48e3a}Séléction d'un graphique de distribution}
\end{figure*}
\subsubsection*{Courbe de densité}
\label{sec:orgbcd8894}
...
\caption{\label{fig:orgc2bf35d}Composition d'un histogramme}
\end{figure}
...
\caption{\label{fig:org0d5aa8a}Sélection des rêgles de définitions des agrégats}
\end{figure}


L'utilisation d'un histogramme permet d'identifier des schémas de distributions tels que définis dans la figure \ref{fig:org7f1cbc1} : \autocite{jonathanschwabishDistribution2021}

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{./img/histogram-patterns.pdf}
\caption{\label{fig:org7f1cbc1}Illustration des formes remarquables d'un histogramme}
\end{figure}
...
\caption{\label{fig:orgf70b77f}Illustration des variantes de l'histogramme}
\end{figure}

L'histogramme n'est pas adapté aux cas suivant :
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:orgbcd8894]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:orgd189c5a]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:orgd5b39a5]{Matrice de graphique}.
\end{itemize}
\subsubsection*{Valeur lettrée}
\label{sec:org5d67706}
...
\label{sec:orge0333ae}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-evolution.pdf}
\caption{\label{fig:org6b6a9dd}Séléction d'un graphique d'évolution}
\end{figure*}
\subsubsection*{Jauge}
\label{sec:orgf923098}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:org096fa0f]{Tiret}.
\subsubsection*{Ruisseau}
\label{sec:orgf3a3f68}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:orgd5b39a5]{Matrice de graphique}.
\end{itemize}
...
\label{sec:org055e448}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-correlation.pdf}
\caption{\label{fig:orgb9f884f}Séléction d'un graphique de correlation}
\end{figure*}
\subsubsection*{Pareto}
\label{sec:org9006dad}
...
\label{sec:orgf518fde}

Représente la relation entres deux variables continues. \autocite{alansmithLexiqueVisuel}
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:orgbe4d69c})
...
\caption{\label{fig:org07061cc}Formes des points de données}
\end{figure}
...
Ce graphique utilise les couleurs de la palette thermique \ref{fig:org93f06df}.
...
\label{sec:orgcf3abf4}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-deviation.pdf}
\caption{\label{fig:org9d7c55f}Séléction d'un graphique de déviation}
\end{figure*}
\subsubsection*{Alluvial}
\label{sec:org5de1508}
...
\end{center}
\section*{Glossaire}
\label{sec:org379b044}
\section*{Références}
\label{sec:orgf6f0e5f}
