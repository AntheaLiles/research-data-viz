...
\section*{Composants}
\label{sec:orgd3d0dbc}
\subsection*{Polices}
\label{sec:org6f51ea1}
...
\caption{\label{fig:orgd932408}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:org99eada9}Palette binaire}
\end{figure}
...
\caption{\label{fig:org2349876}Palette divergente}
\end{figure}
...
\caption{\label{fig:orge3af066}Palette monochrome}
\end{figure}
...
\caption{\label{fig:org907ad67}Palette thermique}
\end{figure}
...
\caption{\label{fig:org9bae2ad}Palette catégorique}
\end{figure}
...
\caption{\label{fig:orga6b72dd}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:org6d3f3d6}
\subsubsection*{Titre}
\label{sec:org4bcfd8e}
\subsubsection*{Cadre}
\label{sec:org7b45e2b}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:org46d06f3}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:org70ed723]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
\caption{\label{fig:org841ad5a}Contenu type d'un texte alternatif selon le médium concerné}
\end{figure}
...
\label{sec:orgfa30ef1}
\section*{Méthode de validation}
\label{sec:org0eafcc9}
...
\section*{Graphiques}
\label{sec:org39813d1}
\subsection*{Arbre de mot}
\label{sec:orgc2c6101}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org9aea287]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
\label{sec:org4c4135b}

Heatmap
\subsection*{Cascade}
\label{sec:org23d2430}
...
Il est, autrement, en tout point similaire aux \hyperref[sec:org2e47929]{Camembert}
\subsection*{Etats parallèles}
\label{sec:org13fc578}
...
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:org9cfd88a]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:org3f6fad5]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:orge3b89ac]{Matrice de graphique}.
\end{itemize}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:orgbdee5c6]{Tiret}.
\subsection*{Ligne}
\label{sec:orgc614473}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:orge3b89ac]{Matrice de graphique}.
\end{itemize}
...
\caption{\label{fig:orga087681}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Matrice de température}
\label{sec:org7303f1a}
...
\label{sec:org12b85c8}
Représente la relation entres deux variables continues. \autocite{alansmithLexiqueVisuel}
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:org9bae2ad})
...
\caption{\label{fig:org13121bd}Formes des points de données}
\end{figure}
...
Si la quantité de chaque étape d'un processus est l'information la plus importante, il est préférable d'avoir recours à un diagramme en \hyperref[sec:orgb0f48a4]{Barre ordonnée}.

S'il est  souhaité de visualiser les pertes quantitatives au fil d'un processus, il sera préférable d'employer un diagramme de \hyperref[sec:org02777cb]{Sankey}.
\subsection*{Treemap}
\label{sec:org463102d}
