...
\section*{Composants}
\label{sec:org1990d7a}
\subsection*{Polices}
\label{sec:org21945a7}
...
\caption{\label{fig:org21c5fa7}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:orge9f6087}Palette binaire}
\end{figure}
...
\caption{\label{fig:org4d9f040}Palette divergente}
\end{figure}
...
\caption{\label{fig:orga6fe3ab}Palette Séquencielle}
\end{figure}
...
\caption{\label{fig:org70d8c11}Palette thermique}
\end{figure}
...
\caption{\label{fig:orgf2d5d8f}Palette catégorique}
\end{figure}
...
\caption{\label{fig:orgf513635}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:orgd2bcfa3}
Pour qu'un graphique s'intègre correctement dans un document, il convient de prévoir une zone de protection. Dans la figure \ref{fig:orgfa043ab} nous proposons un exemple de protection relative aux largeurs des marges latérales.

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{./img/general-graphics-rules.pdf}
\caption{\label{fig:orgfa043ab}Zones de protection d'un graphique}
\end{figure}
\subsubsection*{Cadre}
\label{sec:org8c48d5d}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:orgfcbb471}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:org325a9e1]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
\caption{\label{fig:org93af192}Contenu type d'un texte alternatif selon l'usage concerné}
\end{figure}
...
\label{sec:orgd7f7e3f}

\section*{Méthode de validation}
\label{sec:org9dabbb8}
...
La seconde direction est de filtrer les types de graphiques en fonction de l'objectif de l'utilisateur. Nous avons poursuivi notre étude dans ce sens. La figure \ref{fig:org450fb51} propose un premier niveau de discrimination des types de représentations en identifiant en premier lieu si le graphique doit s'actualiser en temps réel puis en orientant vers des catégories de graphiques au regards de l'objectif recherché.

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-filter.pdf}
\caption{\label{fig:org450fb51}Parcours de sélection initial}
\end{figure*}
...
\label{sec:org8882387}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-indicateur.pdf}
\caption{\label{fig:org104ffb9}Séléction d'un graphique d'indicateur}
\end{figure*}
\subsubsection*{Marqueur}
\label{sec:orge5557f4}
...
\label{sec:orgd3654b6}

\subsubsection*{Camembert}
\label{sec:orga4c59bc}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:orge5557f4]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
Il est, autrement, en tout point similaire aux \hyperref[sec:orga4c59bc]{Camembert}
\subsubsection*{Quadrillage}
\label{sec:orgff665d2}
...
\label{sec:orgcce82e7}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-classement.pdf}
\caption{\label{fig:org9341ee2}Séléction d'un graphique de classement}
\end{figure*}
\subsubsection*{Barre ordonnée}
\label{sec:org512fd63}
...
\caption{\label{fig:org33021f4}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Distribution}
\label{sec:org9785be7}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-distribution.pdf}
\caption{\label{fig:org8f886af}Séléction d'un graphique de distribution}
\end{figure*}
\subsubsection*{Courbe de densité}
\label{sec:orga7afefc}
...
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:orga7afefc]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:org2f19396]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:orgc086cfd]{Matrice de graphique}.
\end{itemize}
...
\label{sec:org5f00c7c}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-evolution.pdf}
\caption{\label{fig:orge8d858b}Séléction d'un graphique d'évolution}
\end{figure*}
\subsubsection*{Jauge}
\label{sec:org5789666}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:org1b3a327]{Tiret}.
\subsubsection*{Ruisseau}
\label{sec:orga070ac4}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:orgc086cfd]{Matrice de graphique}.
\end{itemize}
...
\label{sec:org5d2d69c}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-correlation.pdf}
\caption{\label{fig:orge2d6722}Séléction d'un graphique de correlation}
\end{figure*}
\subsubsection*{Pareto}
\label{sec:org3b33222}
...
\label{sec:org6a75b87}
Représente la relation entres deux variables continues. \autocite{alansmithLexiqueVisuel}
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:orgf2d5d8f})
...
\caption{\label{fig:org552e721}Formes des points de données}
\end{figure}
...
Ce graphique utilise les couleurs de la palette thermique \ref{fig:org70d8c11}.
...
\label{sec:orga5a4ced}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-deviation.pdf}
\caption{\label{fig:org69f52fc}Séléction d'un graphique de déviation}
\end{figure*}
\subsubsection*{Alluvial}
\label{sec:org653ace2}
...
\label{sec:orgfe3463d}

\section*{Conflits d'intérêt}
\label{sec:org909ccaa}

\section*{Evolution}
\label{sec:orga61f584}
\begin{center}
\begin{tabular}{rl}
Date & Changements\\
\hline
...
\end{center}
\section*{Glossaire}
\label{sec:org2edbe88}
\subsection*{Vocabulaire technique}
\label{sec:org984e678}
\begin{description}
